  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.lightGreen }}>
      ...
      <View style={{ flex: 1, padding: 16, paddingTop: 25, }}>
        <TextBold text={I18n.t("hi") + " " + user.name} style={{ fontSize: Sizes.medium, alignSelf: "flex-start" }} />
        <TextRegular text={I18n.t("feedbacklongtext")} style={{ fontSize: Sizes.medium, alignSelf: "flex-start" }} />
        <TextBold text={I18n.t("rate")} style={{ fontSize: Sizes.medium, alignSelf: "flex-start", marginTop: 20 }}></TextBold>
        <View style={{ flexDirection: "row", marginVertical: 15 }}>
          {[1, 2, 3, 4, 5].map((value, index) => (
            <TouchableOpacity key={index}
              ...
              activeOpacity={.9}
            >
              <Icon name={(star >= value) ? "star" : "star-o"} size={30}
